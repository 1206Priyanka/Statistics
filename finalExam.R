#############################
# random.txt for Resit Exam #
#############################

# Code for Exercise 3
# Remember to replace studentid with your STUDENTID.  If you are student id is C12345678 use only the numeric part 12345678
...
# Remember to read the data into a dataframe or matrix called "cars" for the code to work 
# Remember to replace studentid with your STUDENTID.  If you are student id is C12345678 use only the numeric part 12345678
set.seed(22074213) 
k<-sample(1:392, 300)
mycars<-cars[k,]
